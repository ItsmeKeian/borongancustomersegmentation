...
<div class="modal fade" id="allNotificationsModal" tabindex="-1" aria-labelledby="allNotificationsModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-3 p-0 sidebar">
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link active" href="establishment_filtersegments.php" data-section="segmentation">
    ...
    <div class="card-header">
        <h5 class="card-title mb-0">Filter Segments</h5>
    </div>
    <div class="card-body">
        <div class="row mb-3">
            <div class="col-md-4">
...
<nav aria-label="Customer pagination">
    ...
    <script src="js/establishment_filtersegments.js"></script>
