        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-3 p-0 sidebar">
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link active" href="establishment_settings.php" data-section="settings">
           ...
           <div class="col-lg-10 col-md-9 p-4">
            <div class="dashboard-section active"> 
                ...
                <div class="row"> <div class="col-md-6"> 
                  ...
                  <input type="hidden" id="establishment_sid">

                    <div class="card-body"> 
                        <div class="mb-3"> 
                            <label class="form-label">Business Name</label> 
                            <input type="text" class="form-control" id="business_name"  readonly> 
                        </div> 
                        <div class="mb-3"> 
                        ...
                        <div class="mb-3"> 
                            ...
                            <input type="text" class="form-control" id="owners_name" > 
                        </div> 
                        <div class="mb-3"> 
                      ...
                      <div class="col-md-6">
                         <div class="card mb-4">
                             <div class="card-header">
                                 <h5 class="card-title mb-0">Change Establishment Password</h5> 
                                </div>
                                    ...
                                    <form id="changePasswordForm">
                                            <div class="card-body">
                                                ...
                                                <button type="button" class="btn btn-primary" id="savePasswordBtn">Save Settings</button>
                                            </div>
                                        </form>
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered">
    ...
    $("#savePasswordBtn").click(function(e) {
        ...
        $.post("php/change_password.php", {
            ...
            console.log("Password Change Response:", response); // Debugging
...
$(document).ready(function() {
        ...
        $.getJSON("php/get_business_profile.php", function(response) {
            if (response.status === 1) {
                let data = response.data;
                $("#establishment_sid").val(data.establishment_sid);
    ...
    $.post("php/update_business_profile.php", {
        business_name: $("#business_name").val(),
        business_type: $("#business_type").val(),
        owners_name: $("#owners_name").val(),
        email: $("#email").val(),
        contact: $("#contact").val(),
        address: $("#address").val()
    }, function(response) {
        ...
        if (response.status === 1) {
            ...
            Swal.fire({
                icon: "error",
                title: "Failed!",
                text: response.message || "Error updating record.",
                position: "center",
                customClass: {
                    popup: 'small-alert',
                    title: 'small-title',
