        ...
        <div class="row">
           ...
           <div class="col-lg-2 col-md-3 p-0 sidebar">
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link active" href="establishment_analytics.php" data-section="analytics">
            ...
            <div class="col-lg-10 col-md-9 p-4">
                ...
                <!-- Analytics Section -->
                <div id="analytics" class="dashboard-section active">
                    ...
                    <div class="row mb-4">
                             ...
                             <div class="card mb-4">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">Filter Purchased Reports</h5>
                                    </div>
                                    <div class="card-body">
                                        <div class="row mb-3">
                                            <div class="col-md-4">
                                            ...
                                            <!-- dynamic filter inputs will appear here -->
                                            <div class="col-md-8" id="filterInputs"></div>
                                        </div>
...
<!-- Pagination -->
            <nav aria-label="Customer pagination">
                    ...
                    <ul class="pagination justify-content-center">
                        ...
                        <div class="card-body">
                            <form id="reportForm" method="GET" action="php/generate/generate_reports.php">
                                <div class="row mb-3">
                                    <!-- Report Type -->
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <select name="reportType" id="reportType" class="form-select" required>
                                                ...
                                                <option value="purchased">Purchased Data</option>
                                                <option value="segments">Segments Data</option>
                                            </select>
                                        </div>
                                    </div>
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content">
     ...
     <style>
                    ...
                    /* Custom style for smaller SweetAlert */
            .swal2-popup {
                width: 400px !important; /* Adjust the width */
    ...
    <script src="js/establishment_analytics.js"></script>
