        ...
        <div class="row">
           ...
           <div class="col-lg-2 col-md-3 p-0 sidebar">
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link active" href="establishment_purchased.php" data-section="purchased">
            ...
            <div class="col-lg-10 col-md-9 p-4">
                ...
                <div  class="dashboard-section active">
                    <h2 class="mb-4">Purchased Management</h2>
                    
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h5 class="card-title mb-0">Purchased History</h5>
                             <div>
                     ...
                     <div class="modal fade" id="addCustomerModal" tabindex="-1">
                                <div class="modal-dialog modal-xl">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="col-md-2">
                                            <button class="btn btn-primary mt-4" id="addToCart">➕ Add</button>
                                        </div>
                                        </div>
                                        ...
                                        <input type="datetime-local" id="date_purchase" class="form-control">
                                        </div>
                                    </div>
               ...
               <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Item Purchase</label>
                                <input type="text" id="edit_item_purchase" class="form-control" placeholder="Enter item purchase" >
                            </div>
                           
                            <div class="mb-3">
                                <label class="form-label">Item Price</label>
                                <input type="text" class="form-control" placeholder="Enter item price" id="edit_item_price">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Date Purchase</label>
                                <input type="datetime-local" class="form-control"  id="edit_date_purchase">
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" placeholder="Enter quantity" id="edit_quantity">
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Total</label>
                                <input type="text" class="form-control" placeholder="Enter total" id="edit_total">
                            </div>
                           
                             <div class="mb-3">
                                <label class="form-label">Establishment</label>
                                <input type="email" class="form-control" placeholder="Enter establishment name" id="edit_establishment">
                            </div>
                        </div>
                    </div>
...
<div class="modal fade" id="tutorialModal" tabindex="-1" aria-labelledby="tutorialModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-dialog-centered">
    ...
    <script src="js/establishment_purchased.js"></script>
