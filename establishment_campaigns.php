           ...
           <div class="col-lg-2 col-md-3 p-0 sidebar">
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link " href="establishment_product_analytics.php">
                     ...
                     <a class="nav-link active" href="establishment_campaigns.php" data-section="campaigns">
            ...
            <div class="col-lg-10 col-md-9 p-4">
                ...
                <!-- Campaigns Section -->
                <div id="campaigns" class="dashboard-section active" >
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#createCampaignModal"><i class="fas fa-plus me-1"></i> Sent Campaign</button>
                            </div>
    ...
    <div class="modal-content">
      <form id="campaignForm">
        ...
        <div class="modal-header">
          <h5 class="modal-title">Sent New Campaign</h5>
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <select class="form-select" id="targetSegment" required>
                <option value="" selected disabled>Loading segments...</option>
            </select>
          </div>
          
          <div class="mb-3">
            <label class="form-label">Channel</label><br>
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="channel" value="sms" checked>
          ...
          <div class="mb-3">
            ...
            <div class="form-text">Max 160 characters for SMS</div>
          </div>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary">Sent Campaign</button>
        </div>
      </form>
    </div>
  </div>
...
<div class="modal fade" id="tutorialModal" tabindex="-1" aria-labelledby="tutorialModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-dialog-centered">
    ...
    <script src="js/establishment_campaign.js"></script>
