...
<head>
    ...
    <title>Admin Dashboard - Borongan City Customer Segmentation</title>
    <!-- Bootstrap CSS -->
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-10 col-md-9 p-4">
                ...
                <div id="adminDashboardSection" class="dashboard-section active">
                   ...
                   <div class="row mb-4">
                        <div class="col-md-3 mb-3">
                            <div class="card stat-card">
                                ...
                                <div class="number" id="a3"></div>
                                <div class="label">Total Establishments</div>
                            </div>
                        </div>
                        <div class="col-md-3 mb-3">
                            <div class="card stat-card">
                                <i class="fas fa-users"></i>
                                <div class="number" id="a2"></div>
                                <div class="label">Total Establishment Type</div>
                            </div>
                        </div>
                        <div class="col-md-3 mb-3">
                            <div class="card stat-card">
                                 <i class="fas fa-clipboard-list"></i>
                                <div class="number" id="syslogs">22</div>
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="card stat-card">
                                ...
                                <div class="number" id="loginlogs">22.5%</div>
                                <div class="label">Loggin Attempts</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-8 mb-3">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Establishment Growth</h5>
                                </div>
                                <div class="card-body">
                                    <div class="chart-container">
                                        <canvas id="establishmentGrowthChart" style="height: 170px;" width="610px"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Establishment Types</h5>
                                </div>
                               <div class="card-body text-center">
                                    <div class="chart-container">
                                        <canvas id="establishmentTypeChart" style="width: 100%; max-width: 300px;" ></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
