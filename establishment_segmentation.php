...
<div class="modal fade" id="viewSegmentCustomersModal" tabindex="-1">
  <div class="modal-dialog modal-xl modal-fullscreen-md-down modal-dialog-scrollable">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title" id="segmentModalTitle">Segment Customers</h5>
      ...
      <div class="modal-body">
        <div class="table-responsive">
          <table class="table table-bordered table-hover">
            ...
            <tbody id="segmentCustomerTable"></tbody>
          </table>
        </div>
      </div>
...
<style>
    ...
    #viewSegmentCustomersModal table {
        font-size: 0.85rem;
    }
}
                ...
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link " href="establishment_product_analytics.php">
                      ...
                      <a class="nav-link" href="establishment_campaigns.php" data-section="campaigns">
                        ...
                        <a class="nav-link active" href="establishment_segmentation.php" data-section="segmentation">
...
<div class="modal fade" id="tutorialModal" tabindex="-1" aria-labelledby="tutorialModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-dialog-centered">
            ...
            <div class="col-lg-10 col-md-9 p-4">
                <!-- Dashboard Section -->
                 <button class="btn btn-primary" style="float: right;" 
                    ...
                    <i class="fas fa-plus me-1"></i> Create New Segment
                </button>
                 ...
                 <div  class="dashboard-section active">
                    ...
                    <div class="row mb-4" id="segmentCards">
                        ...
                        <div class="modal-dialog modal-lg">
                            ...
                            <form id="segmentForm">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="segment_name" name="segment_name" required placeholder="E.g., Loyal Customers">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="row">
                                    <div class="col">
                                        <input type="number" class="form-control" placeholder="Min" id="age_min" name="age_min" required>
                                    </div>
                                    <div class="col">
                                        <input type="number" class="form-control" placeholder="Max" id="age_max" name="age_max" required>
                                    </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="description" name="description" rows="3" placeholder="Write a short description of this segment..."></textarea>
                                </div>
    ...
    <script src="js/establishment_segmentation.js"></script>
