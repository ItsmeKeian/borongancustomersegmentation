        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-3 p-0 sidebar ">
                <nav class="nav flex-column">
                    <a class="nav-link active" href="establishment_dashboard.php" data-section="dashboard">
                ...
                <div class="dashboard-section active">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="card stat-card">
                                ...
                                <div class="number" id="count_segment"></div>
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="card stat-card">
                                ...
                                <div class="number" id="countsentcampaign"></div>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-8 mb-3">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Monthly Customer Growth</h5>
                                </div>
                                <div class="card-body">
                                    <div class="chart-container">
                                        <canvas id="growthChart" style="height: 150px;" width="500px"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                       <div class="col-md-4 mb-3">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Customer Count by Segment</h5>
                                </div>
                   ...
                   <div class="card">
                        <div class="card-header">
                            <h6 class="mb-0">Revenue by Segment</h6>
                        </div>
                        <div class="card-body">
                            <div class="chart-container">
...
<div class="modal fade" id="tutorialModal" tabindex="-1" aria-labelledby="tutorialModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-dialog-centered">
    ...
    <script src="js/establishment_dashboard.js"></script>
